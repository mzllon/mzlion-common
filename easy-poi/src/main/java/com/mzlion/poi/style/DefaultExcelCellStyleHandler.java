...
public class DefaultExcelCellStyleHandler extends AbsExcelCellStyleHandler {
    ...
    public CellStyle getDataCellStyle(int rowIndex, Object value, Class<?> valueClass, ExcelCellHeaderConfig excelCellHeaderConfig, CellStyle cloneCellStyle) {
        cloneCellStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
        cloneCellStyle.setAlignment(CellStyle.ALIGN_CENTER);

        cloneCellStyle.setBorderLeft(CellStyle.BORDER_THIN);
        cloneCellStyle.setBorderTop(CellStyle.BORDER_THIN);
        cloneCellStyle.setBorderRight(CellStyle.BORDER_THIN);
        cloneCellStyle.setBorderBottom(CellStyle.BORDER_THIN);

        cloneCellStyle.setWrapText(excelCellHeaderConfig.isAutoWrap());
        ...
        if (excelCellHeaderConfig.getExcelCellType().equals(ExcelCellType.HYPER_LINK)) {
            if (valueClass.equals(String.class)) {
                ...
                cloneCellStyle.setFont(hyperlinkFont);
            }
        } else {
            Font font = this.workbook.createFont();
            font.setFontHeightInPoints((short) 10);
            font.setFontName("宋体");
            cloneCellStyle.setFont(font);
        }
